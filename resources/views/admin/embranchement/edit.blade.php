    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        Modifier Embranchement
                    </h2>
                </div>
                <div class="body">
                    <form action="{{ route('admin.embranchement.update', $embranchement->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="form-group form-float">
                            <div class="form-line">
                                <input type="text" id="name" name="name" class="form-control" value="{{ $embranchement->name }}">
                                <label class="form-label">Nom de l'embranchement</label>
                            </div>
                        </div>

                        <br>

                        <a href="{{ route('admin.embranchement.index') }}" class="btn btn-danger m-t-15 waves-effect">Retour</a>
