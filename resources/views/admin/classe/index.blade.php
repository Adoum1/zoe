            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                           Nombre Classe
                            <span class="badge bg-blue">{{ $classes->count() }}</span>
                        </h2>
                                    ...
                                    @foreach($classes as $key=>$classe)
                                       ...
                                       <tr>
                                           ...
                                           <td class="text-center">
                                               <a href="{{ route('admin.classe.edit', $classe->id) }}" class="btn btn-info waves-effect">
                                                   <i class="material-icons">edit</i>
                                               </a>

                                               <button class="btn btn-danger waves-effect" type="button" onclick="deleteClasse({{ $classe->id }})">
                                                   <i class="material-icons">delete</i>

                                               </button>

                                               <form id="delete-form-{{ $classe->id }}" action="{{ route('admin.classe.destroy',$classe->id) }}" method="POST" style="display: none;">
                                                   @csrf
                                                   @method('DELETE')
