    ...
    <div class="container-fuild">
        <h2>
            <ol class="breadcrumb breadcrumb-bg-pink">
                ...
                <li class="active"><i class="material-icons">library_books</i> Modifier un lot</li>

            </ol>
        </h2>
        <!-- Vertical Layout | With Floating Label -->
        <form action="{{ route('admin.lot.update', $lot->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                    ...
                    <div class="card">
                        <div class="body">
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="form-line">
                                    <input type="text" id="libelle" name="libelle" class="form-control" value="{{ $lot->libelle }}">
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="form-line">
                                    <input type="text" id="type" name="type" class="form-control" value="{{ $lot->type }}">
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="form-line">
                                    <input type="text" id="entree" name="entree" class="form-control" value="{{ $lot->entree }}">
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="form-line">
                                    <input type="text" id="sortie" name="sortie" class="form-control" value="{{ $lot->sortie }}">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="form-line">
                                    <input type="text" id="numCasier" name="numCasier" class="form-control" value="{{ $lot->numCasier }}">
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="form-line">
                                    <input type="text" id="salle" name="salle" class="form-control" value="{{ $lot->salle }}">
