                    ...
                    <div class="card">
                        <div class="body">
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="form-line">
                                    <input type="text" id="nom" name="nom" class="form-control" value="{{ $site->nom }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="rue" id="tinymce" cols="10" rows="10">{!! $site->rue !!}</textarea>
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="form-line">
                                    <input type="text" id="pays" name="pays" class="form-control" value="{{ $site->pays }}">
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="form-line">
                                    <input type="text" id="commune" name="commune" class="form-control" value="{{ $site->commune }}">
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="form-line">
                                    <input type="text" id="cp" name="cp" class="form-control" value="{{ $site->cp }}">
